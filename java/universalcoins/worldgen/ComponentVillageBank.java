...
public class ComponentVillageBank extends StructureVillagePieces.Village {
	...
	public static ComponentVillageBank buildComponent(Start startPiece, List pieces, Random random, int p1, int p2, int p3, EnumFacing facing,
			int p5) {
	...
	public boolean addComponentParts(World world, Random random, StructureBoundingBox sbb) {
		...
		// start with block
		func_175804_a(world, sbb, 0, 0, 0, 4, 3, 5, Blocks.stone.getDefaultState(), Blocks.stone.getDefaultState(), false);
		// windows
		func_175804_a(world, sbb, 0, 2, 2, 4, 2, 3, Blocks.glass.getDefaultState(), Blocks.glass.getDefaultState(), false);
		// roof
		func_175804_a(world, sbb, 0, 4, 1, 4, 4, 5, Blocks.stone_slab.getDefaultState(), Blocks.stone_slab.getDefaultState(), false);
		func_175804_a(world, sbb, 1, 4, 2, 3, 4, 4, Blocks.double_stone_slab.getDefaultState(), Blocks.double_stone_slab.getDefaultState(), false);
		// clear inside
		...
		// atm - meta, LR, TB, FB
		this.func_175811_a(world, UniversalCoins.proxy.blockCardStation.getStateFromMeta(getCorrectedMeta(3)), 2, 2, 4, boundingBox);
		this.func_175811_a(world, UniversalCoins.proxy.blockBase.getDefaultState(), 2, 1, 4, boundingBox);
		// door
		this.func_175810_a(world, boundingBox, random, 2, 1, 1, EnumFacing.getHorizontal(
				this.getMetadataWithOffset(Blocks.oak_door, 3)));
		// torches
		...
		// sign
		this.func_175811_a(world, UniversalCoins.proxy.wall_ucsign.getStateFromMeta(getCorrectedMeta(3)), 1, 2, 0, boundingBox);
