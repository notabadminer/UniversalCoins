...
public class UCGive extends CommandBase {
	...
	public void execute(ICommandSender sender, String[] args) throws CommandException {
		if (args.length == 2) {
			...
			sender.addChatMessage(new ChatComponentText("Gave " + args[0] + " " + (coinsToSend - change) + 
					" " + StatCollector.translateToLocal("item.itemCoin.name")));
			recipient.addChatMessage(new ChatComponentText( sender.getCommandSenderEntity() + " " +
