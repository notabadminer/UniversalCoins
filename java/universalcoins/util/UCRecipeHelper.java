...
public class UCRecipeHelper {
	...
	public static void addVendingBlockRecipes() {
		GameRegistry.addShapedRecipe(new ItemStack(UniversalCoins.proxy.blockVendor), new Object[] { "XXX", "XRX",
	...
	public static void addEnderCardRecipes() {
		...
		GameRegistry.addShapedRecipe(new ItemStack(UniversalCoins.proxy.itemEnderCard),
				new Object[] { "XEX", "ECE", "XEX", 'E', Items.ender_pearl, 'C', UniversalCoins.proxy.itemUCCard });
	}
