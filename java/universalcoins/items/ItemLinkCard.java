        ...
        if (movingobjectposition != null && movingobjectposition.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK) {
            ...
            if (world.getTileEntity(cursorPos) instanceof TileEntityChest) {
            	...
            	player.addChatMessage(new ChatComponentText(
            			StatCollector.translateToLocal("item.linkCard.message.stored") + cursorPos.getX() + " " + cursorPos.getY() + " " + cursorPos.getZ()));
            	itemstack.getTagCompound().setIntArray("storageLocation", new int[] {cursorPos.getX(), cursorPos.getY(), cursorPos.getZ()});
            }
