	        ...
	        else
	        {
	            ...
	            else
	            {
	                if (side == EnumFacing.UP)
	                {
	                    ...
	                    worldIn.setBlockState(pos, UniversalCoins.proxy.standing_ucsign.getDefaultState().withProperty(BlockUCStandingSign.ROTATION, Integer.valueOf(i)), 3);
	                }
	                else
	                {
	                    worldIn.setBlockState(pos, UniversalCoins.proxy.wall_ucsign.getDefaultState().withProperty(BlockUCWallSign.FACING, side), 3);
	                }
